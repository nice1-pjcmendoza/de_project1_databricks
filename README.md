...
I integrated Github Copilot, Databricks Genie, and ChatGPT into this project to assist me in writing codes, analyzing data, and documentating my work. However, I made sure to review and understand all the codes generated by these AI tools, and I only included materials that I fully comprehend and can explain. I also added my own research and explanations to the code to ensure that it is clear and understandable for anyone who reads it.
